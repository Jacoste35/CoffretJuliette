...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL ?? "https://comptoir-des-chatonniers.vercel.app",
  ),
  title: {
    default: "Coffrets & paniers garnis de Normandie",
    template: "%s — Coffrets de Normandie",
  },
  description:
  ...
  openGraph: {
    type: "website",
    locale: "fr_FR",
    title: "Coffrets & paniers garnis de Normandie",
    description:
          ...
          <div className="container grid gap-8 py-10 text-sm md:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-creme/70">
                Coffrets cadeaux gourmands composés de produits de producteurs
                normands et français.
              </p>
            </div>
            <div>
              <p className="font-medium">Notre engagement</p>
              <p className="mt-2 text-creme/70">
                Chaque produit porte le nom de son producteur, sa commune et son
                département. Aucune origine n&apos;est affirmée sans preuve.
              </p>
            </div>
            <div>
              <p className="font-medium">Version</p>
              <p className="mt-2 text-creme/70">
                V1 — parcours client, moteur de composition et devis. Paiement,
                signature électronique et suivi de colis à venir.
              </p>
            </div>
          </div>
        </footer>
